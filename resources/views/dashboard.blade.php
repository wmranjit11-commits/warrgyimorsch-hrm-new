                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <a href="javascript:void(0);">
                                                        <span
                                                            class="d-block text-truncate-1-line">{{ $rp->employee->name }}</span>
                                                        <span
                                                            class="fs-12 d-block fw-normal text-muted small text-uppercase">{{ $rp->employee->designation }}</span>
                                                    </a>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge {{ $rp->status == 'paid' ? 'bg-soft-success text-success' : 'bg-soft-warning text-warning' }} text-uppercase">
                                                    {{ $rp->status }}
                                                </span>
                                            </td>
                                            <td class="text-end">
                                                <div class="d-flex align-items-center justify-content-end gap-2">
                                                    <a href="{{ route('payroll.export', ['id' => $rp->id, 'format' => 'pdf']) }}"
