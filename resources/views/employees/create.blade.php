...
@section('content')
    ...
    <div class="main-content">
        ...
        <form method="POST" action="{{ route('employees.store') }}" enctype="multipart/form-data" autocomplete="off" class="employee-premium-form">
            @csrf
                    ...
                    <div class="row g-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select name="department" class="form-control" required>
                                    ...
                                    @foreach($departments as $dept)
                                        <option value="{{ $dept->name }}" {{ old('department') == $dept->name ? 'selected' : '' }}>{{ $dept->name }} {{ $dept->short_name ? '('.$dept->short_name.')' : '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select name="designation" class="form-control" required>
                                    ...
                                    @foreach($designations as $desg)
                                        <option value="{{ $desg->name }}" {{ old('designation') == $desg->name ? 'selected' : '' }}>{{ $desg->name }} {{ $desg->short_name ? '('.$desg->short_name.')' : '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <span class="input-group-text bg-white" onclick="togglePassword('createEmpPassword', this)" style="cursor:pointer; border-left:none;">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <textarea name="address" class="form-control" placeholder="Enter Address" style="height: 45px;">{{ old('address') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label>Time In</label>
                        ...
                        <div class="col-md-12 mt-4">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" name="insurance" id="insuranceToggle" {{ old('insurance') ? 'checked' : '' }} style="width: 40px; height: 20px;">
